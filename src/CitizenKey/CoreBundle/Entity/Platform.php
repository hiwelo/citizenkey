 ...
 * @ORM\Entity(repositoryClass="CitizenKey\CoreBundle\Repository\PlatformRepository")
 */
class Platform
{
    /**
     ...
     * Set owner
     *
     * @param \CitizenKey\CoreBundle\Entity\User $owner
     *
     * @return Platform
     */
    public function setOwner(\CitizenKey\CoreBundle\Entity\User $owner = null)
    {
        $this->owner = $owner;
